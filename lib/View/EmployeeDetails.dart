              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CommonFunctions.commonSpace(height * 0.02, 0),
                    Text('Employee Email', style: textTheme.labelMedium),
                    CommonFunctions.commonSpace(height * 0.01, 0),
                    ...
                    CommonFunctions.commonSpace(height * 0.02, 0),
                    Text('Employee CNIC', style: textTheme.labelMedium),
                    CommonFunctions.commonSpace(height * 0.01, 0),
                    ...
                    CommonFunctions.commonSpace(height * 0.02, 0),
                    Text('Employee Contact', style: textTheme.labelMedium),
                    CommonFunctions.commonSpace(height * 0.01, 0),
                    ...
                    CommonFunctions.commonSpace(height * 0.02, 0),
                    Text('Employee Position', style: textTheme.labelMedium),
                    CommonFunctions.commonSpace(height * 0.01, 0),
                    ...
                    CommonFunctions.commonSpace(height * 0.02, 0),
                    Text('Employee Salary', style: textTheme.labelMedium),
                    CommonFunctions.commonSpace(height * 0.01, 0),
                    ...
                    CommonFunctions.commonSpace(height * 0.02, 0),
                    Text('Employee BranchID', style: textTheme.labelMedium),
                    CommonFunctions.commonSpace(height * 0.01, 0),
