...
import 'package:pharmasage/View/SetPassword.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Please enter Your Email to receive recovery code.',style: textTheme.bodyMedium),
                CommonFunctions.commonSpace(height*0.03, 0),
                Text('Email',style: textTheme.bodyMedium),
                CommonFunctions.commonSpace(height*0.015, 0),
                textInputField(textTheme,'Enter your phone number or Email'),
                ...
                ElevatedButton(
                    ...
                    onPressed:() async{
                      ...
                      await services.forgetPassword(context, emailController.text.toString());
                      //CommonFunctions.showSuccessToast(context: context, message: 'Password Reset Successfully');



                      },
                    child:Text('Send',style: textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold,color: Colors.white),)),
