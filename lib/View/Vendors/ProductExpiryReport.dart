                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(child: Text('Within a Week', style: textTheme.bodyLarge!.copyWith(color: Colors.white))),
                                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(child: Text('Within a Month', style: textTheme.bodyLarge!.copyWith(color: Colors.white))),
                                ),
                                CommonFunctions.commonSpace(height * 0.04, 0),
                                Center(
                                  child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(child: Text('Within a Year', style: textTheme.bodyLarge!.copyWith(color: Colors.white))),
                                ),
                                CommonFunctions.commonSpace(height * 0.04, 0),
                                Center(
                                  child: Container(
