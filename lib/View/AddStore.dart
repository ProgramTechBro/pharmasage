    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title:Text('Add New Branch', style: textTheme.displaySmall!.copyWith(fontWeight: FontWeight.w500,color: Colors.white)),
          centerTitle: true,
        ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Enter Store Details here :',style: textTheme.bodyMedium),
                CommonFunctions.commonSpace(height*0.03,0 ),
                ...
                Text('Branch Name',style: textTheme.bodyMedium),
                CommonFunctions.commonSpace(height*0.008, 0),
                ...
                CommonFunctions.commonSpace(height*0.02, 0),
                Text('Branch Manager Name',style: textTheme.bodyMedium),
                CommonFunctions.commonSpace(height*0.008, 0),
