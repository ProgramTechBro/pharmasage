...
class PdfInvoiceApi {
  ...
  static Widget buildHeader(Invoice invoice,Font appFont) => Column(
      ...
      Row(
        ...
        children: [
          Row(
            ...
            children: [
              Text('Invoice No:',style: TextStyle(font: appFont,fontSize: 20)),
              Text(invoice.info.orderId,style: TextStyle(font: appFont,fontSize: 20)),
            ],),
          ...
          Row(
            ...
            children: [
              ...
              Text(invoice.info.orderDate,style: TextStyle(font: appFont,fontSize: 20)),
            ],),
          //SizedBox(width: 0.5 * PdfPageFormat.cm),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              ...
              Text(invoice.info.orderTime,style: TextStyle(font: appFont,fontSize: 20)),
            ],),
  ...
  static Widget buildStoreInfo(Store store,Font appFont) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
  ...
  static Widget buildInvoice(Invoice invoice,Font appFont) {
    final headers = [
      'Description',
      'Quantity',
      'Unit Price',
  ...
  static Widget buildTotal(Invoice invoice,Font appFont) {
    final totalUnitPrices = invoice.items.map((item) => item.unitPrice).reduce((item1, item2) => item1 + item2);
    final delivery=invoice.info.delivery;
    final total = totalUnitPrices + invoice.info.delivery;
